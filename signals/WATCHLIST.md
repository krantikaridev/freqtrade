...
Primary X: **@i36do** (mmmiitr). Research-only on Serenity — not auto-trade.

## Core feeds
| Source | Notes |
| --- | --- |
| Quantral top | citrini, aleabitoreddit, jukan05, crux_capital_, michaelsikand, … |
| Your feed slice | TechCharts, mind1nvestor, anandragn, VJNCapital, NoLimitGains, Nostre_damus, TFMetals, GavMcCracken, Polymarket |
| Bookmark ideas | 8/21 EMA A/B · TraderDev mining · TV MCP later · sell-puts later · BTC cycle regime |
| Grok Tasks (email) | Gold + crypto signals — via Gmail when connected |
...
See also: `STUCK.md`, `PERSONA.md`, `watchlist.json`
