"""
Sleeve 2 — MaxDrawdown protection tweak iterate

Same LongNoSol entries/ROI/SL; tighter MaxDrawdown: 8% threshold,
72-candle lookback, trade_limit 2, 36-candle lockout (vs champ 12%/48/1/24).
"""
...
class TrendFollowingMaxDD(IStrategy):
    INTERFACE_VERSION = 3
    ...
    def leverage(
        ...
        **kwargs,
        ...
        return min(1.0, max_leverage)  # micro seed path
